#!/usr/bin/env python3
"""
OPTICUS: Simple ResNet Training Example

This script demonstrates how to train a ResNet model using OPTICUS.
"""
...
def main():
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
        optimizer, T_max=2, eta_min=1e-5
    )
    ...
    trained_model = train_model(
        ...
        save_path='checkpoints/resnet_best.pth',
        verbose=True
    )
    ...
    # Generate plots
    save_all_plots(test_metrics, 'plots/resnet_example', unit='cm')
    print("Plots saved to plots/resnet_example/")
